...
const TelemetricContext = createContext<TelemetricContextType | undefined>(undefined);
...
export function TelemetricProvider({ children, projectId, version, trackOnLocalhost = false }: TelemetricProviderProps) {
  useEffect(() => {
